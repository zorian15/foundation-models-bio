...
BOOK_TITLE = "Foundation Models for Biology"
BOOK_SUBTITLE = "How foundation models fit modern molecular biology and drug discovery — a practitioner's bridge."
...
# The book's canonical address, e.g. "https://zorian15.github.io/foundation-models-bio".
...
<meta name="apple-mobile-web-app-title" content="FM Bio">
<meta name="description" content="A textbook on how foundation models are applied to proteins, genomes, and cells — for an ML practitioner.">
"""
...
def quiz_section_html(slug: str) -> str:
    ...
    return (
        ...
        '<p class="quiz-intro">Questions a sharp collaborator might ask on this '
...
def glossary_body_html() -> str:
    ...
    intro = (
        ...
        "defined for an ML practitioner. Each is also defined inline where it "
        "first appears.</p>"
    )
    return intro + '\n<dl class="glossary">\n' + "\n".join(items) + "\n</dl>"
...
def sidebar_html(active_slug: str) -> str:
    ...
    parts.append(
        '<a class="book-brand" href="index.html">Foundation Models<br>for Biology'
...
<img class="landing-cover" src="assets/cover.svg" width="640" height="960"
  alt="The book cover: a chain of residues folding back on itself with dashed contacts, a sequence becoming a structure.">
<div>
